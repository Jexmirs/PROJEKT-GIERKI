var text_1 = "Sadisticc";
var scale = 6;
var posY_Selected = 1;
var spacing = 60;
var text_width = string_width(text_1) + (string_length(text_1) - 1) * spacing;
var start_x = (grabCamera_Width - text_width) + camera_get_view_x(view_camera[0]) + 300;
...
for (var i = 1; i < string_length(text_1); i++) {
    ...
    if (i == current_Letter) {
        ...
        draw_text_ext_transformed_color(x_offset, start_y + posY_Selected, letter, 200, 200, scale, scale, wiggle, color2, color, color, color, 1);
    }
