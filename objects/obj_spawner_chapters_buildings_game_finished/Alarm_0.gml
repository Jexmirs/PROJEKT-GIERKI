...
var distance = 40;
var left =  instance_create_layer(grabCamera_X+grabCamera_Width-distance+500, grabCamera_Y+grabCamera_Height, "Instances_OnTop", obj_buildings_chapters_game_finished);
    left.direction = 180;
	left.speed = 2;
